...
// Seed suggested events if table is empty
const count = db.prepare('SELECT COUNT(*) as n FROM suggested_events').get() as { n: number };
if (count.n === 0) {
  const suggestions = [
    ...
    { title: "Saugatuck Dunes State Park Hike", description: "Explore 13 miles of trails through 200-foot coastal dunes with 2.5 miles of secluded Lake Michigan beach. The Beach Trail is the shortest route at 0.75 miles one-way. Great for all skill levels with stunning lake views!", latitude: 42.7089, longitude: -86.2167, location_name: "Saugatuck Dunes State Park", address: "138th Ave & State Park Dr, Holland, MI 49423", contact_phone: "(269) 637-2788", contact_email: null, website_url: "https://www.michigan.gov/recsearch/parks/saugatuck", reviews_url: "https://www.alltrails.com/parks/us/michigan/saugatuck-dunes-state-park", image_url: "https://www.michigan.org/sites/default/files/listing_images/profile/12676/94e989739117bd23a2423ac473232d42_saugdunessp-sand-path.jpg" },
